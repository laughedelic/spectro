...
Now that the GPU was being fed a stream of FFT data, I needed to map it to pixels on the screen. For
...
I used a similar technique for implementing the frequency scale option, which makes different
